...
<template>
    ...
    <header class="">
        <div class="container-1296">
            <section style="background-position: center 40px; background-size: 560px 560px; background-repeat: no-repeat; @media screen and (min-width: 768px) { background-size:800px 800px;}"
                class="bg-[url(/assets/images/index/mixedCircle.svg)]
                pt-12 px-3 text-center md:pt-20 bg-fixed">
                <h1 class="cusText-5xl" v-html="h1Value" data-aos="fade-down"></h1>
                
                <section class="pb-12 md:pb-20">
                    <div class="mt-6 mb-10 md:flex space-y-4 md:gap-6 md:text-left max-w-[815px] mx-auto text-center">
                        <p class="cusText-b-lg text-natural-50 py-spac-4" data-aos="fade-right">自由工作很美，也很難。<br>
                            我們用 1 對 1 陪伴，陪你從第一步開始，直到夢想變成日常
                        </p>
    
                        <button class="btn-lg mx-auto mb-10 md:mr-0" data-aos="fade-left">
                            開始你的職旅
                    ...
                    <picture class="flex overflow-x-scroll md:gap-6 h-[200px] md:h-[400px] w-full md:grid md:grid-rows-7 md:[grid-template-columns:608px_608px_608px]" data-aos="zoom-in-left">
    ...
    <section class="bg-[linear-gradient(to_top,_#F0F3F5_200px,_transparent_200px)]">
        <div class="container-1296">
            <section class="px-3 md:px-0 md:grid grid-cols-3 gap-6 py-12 md:py-20">
                <div class="col-span-1 my-auto" data-aos="zoom-in-right">
        ...
        <div class="container-1296">
            <div class="px-3 md:px-0 space-y-6 md:space-y-12 py-12 md:py-20">
                <div class="flex items-center justify-center flex-col relative">
                    <img src="/assets/images/index/img.svg" alt="bg-img" class="absolute right-0 top-0 invisible md:visible" data-aos="fade-left">
                    <p class="cusText-xl text-primary-main border-2 border-primary-main py-4 px-5 rounded-radius-12 inline-block relative mb-4 bg-natural-light" data-aos="flip-left">為什麼？
                    ...
                    <h2 class="cusText-5xl" data-aos="zoom-in">選擇職旅 WorkWay</h2>
        ...
        <div class="container-1296">
            ...
            bg-[url(/assets/images/index/choose/gradient-ball.png)] bg-[length:400px_400px] md:bg-[length:800px_800px] bg-no-repeat bg-[position:135px_530px] md:bg-[position:calc(100%+300px)_calc(100%+300px)]">
                ...
                <div class="cusText-b-lg text-natural-50 flex flex-col gap-6 md:px-3 col-span-1">
                    <h2 class="cusText-5xl text-natural-main text-center md:text-left" data-aos="fade-down">遇見你的職涯夥伴</h2>
                    <p>每位顧問都有獨特專長，更重要的是：</p>
                    <p class="p-2 cusText-2xl text-primary-60 bg-natural-95 mx-auto md:ms-0" data-aos="fade-left">“他們都曾面對你正在經歷的挑戰”</p>
        ...
        <div class="container-1296">
            <section class="py-12 md:py-20 px-3 md:px-0 space-y-6 md:space-y-12">
                <div class="space-y-4 md:space-y-6 text-center">
                    <h2 class="cusText-5xl text-natural-light" data-aos="fade-down">服務流程</h2>
                    <p class="cusText-b-lg text-natural-light" data-aos="flip-up">簡單四步，踏上你的職旅</p>
                </div>
    ...
    <section class="bg-[url(/assets/images/index/bg-grid.png)] bg-repeat">
        <div class="container-1296">
            ...
            <div class="flex flex-col py-12 md:py-20 gap-6 md:gap-12 px-3 md:-x-0">
                ...
                <div class="flex items-center justify-center flex-col relative">
                    <p class="cusText-xl text-primary-main border-2 border-primary-main py-3 px-6 rounded-radius-12 inline-block relative mb-4 bg-natural-light" data-aos="flip-left">\ Q&A /
                        <span class="absolute left-1/2 top-full -translate-x-1/2 w-0 h-0 border-x-[15px] border-x-transparent border-t-[15px] border-t-primary-main"></span>
                        <!-- 內層三角形：往下 2px、尺寸小 2px -->
                        <span class="absolute left-1/2 top-full -translate-x-1/2 w-0 h-0 border-x-[13px] border-x-transparent border-t-[13px] border-t-natural-light"></span>
                    </p>
                    <h2 class="cusText-5xl" data-aos="flip-down">你可能有些困惑...</h2>
                </div>

                <div class="grid grid-cols-12">
                    
                    <figure class="hidden md:grid h-[400px] w-[400px] col-start-1 self-end" data-aos="fade-up-right">
                    ...
                    <div class="col-span-12 md:-col-end-1 md:col-span-7 space-y-4 md:space-y-6">
                        <div class="rounded-radius-12 border border-natural-85 bg-natural-light shadow-boxShadow overflow-hidden hover:shadow-lg hover:bg-natural-95"
                            ...
                            <button :id="'qa+{{ i+1 }}'" class="flex w-full text-left gap-2 border-0 cusText-b-lg font-bold text-natural-50 p-6 pb-4" @click="toggle(i)">
